			...
			<div class="p_b6">
				<div class="option_b_box virt_clr">
					...
					<div class="fbox fbox_ty1">
						...
						<div class="cad_ty1">
							<input id="fst_trd_dt" type="text" maxlength="10" class="int_ty1 calendar" />
					...
					<div class="fbox fbox_ty1">
						...
						<div class="cad_ty1">
							<input id="set_dt" type="text" maxlength="10" class="int_ty1 calendar" />
...
<script>
$(function(){
	fng.util.loadScript('/scripts/setting_01-02.js');
});
</script>