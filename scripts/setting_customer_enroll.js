$(function(){
    ...
    function create(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_customer_enroll_create.asp',
            param:param,
    ...
    function update(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_customer_enroll_update.asp',
            param:param,
    ...
    function remove(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_customer_enroll_delete.asp',
            param:param,
    ...
    $('.btn_exdown').click(function(){
        fng.debug.log('excel download');
    });
});
