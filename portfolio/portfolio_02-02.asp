<div class="cont_wrap">
	<div class="guide_area virt_clr">
		<p class="gd f-r"><span>포트폴리오분석</span><span> > </span><span>포트폴리오 정보</span><span> > </span><strong>채권 신용등급별 현황</strong></p>
		<a href="" class="btn_print">인쇄</a>
	</div>
	<section class="section_pg">
		<h1 class="pg_title">채권 신용등급별 현황</h1>
		<!-- 상단 -->
		...
		<section class="section_box">
			...
			<div class="ctab_box">
				<p class="ctabbox_wrap">
					<a href="" data-id="grid" class="tab f-l m_r1 active">신용등급 현황</a>
					<a href="" data-id="chart" class="tab f-l">신용등급 그래프</a>
				</p>
			</div>
			<div id="gridDiv" class="gridgroup10 tabdiv" style="display:block;">
	        	<div id="grid"></div>
	    	</div>
	    	<div id="chartDiv" class="tabdiv gf_box" style="display:none;">
...
<script>
$(function(){
	fng.util.loadScript('/scripts/portfolio_02-02.js');
});
</script>