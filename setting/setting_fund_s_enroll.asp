<div class="cont_wrap">
	...
	<section class="section_pg">
		...
		<section class="section_box">
			...
			<div class="gridgroup5 scwrap h_ty2">
			  	<div id="PfundGrid"></div>
			</div>
			<div class="gridgroup5 scwrap h_ty2">
				<div id="CfundGridEmpty">
					<table class="table_ty1 fserl-2">
						<colgroup>
							<col class="col1">
							<col class="col2">
							<col class="col3">
			...
			<div class="p_b6">
				<div class="option_b_box virt_clr">
					...
					<div class="fbox fbox_ty1">
						...
						<div class="cad_ty1">
							<input id="fst_trd_dt" name="" type="text" maxlength="10" class="int_ty1 fncalendar" />
					...
					<div class="fbox fbox_ty1">
						...
						<div class="cad_ty1">
							<input id="set_dt" name="" type="text" maxlength="10" class="int_ty1 fncalendar" />
