...
<%
	...
	Dim cust_cd, bm_cd, std_dt, work_id, bm_nm, use_yn
	...
	Comm.Parameters.Append Comm.CreateParameter("IN_USE_YN", adVarChar, adParamInput, 20, use_yn)
	...
	Comm.CommandText = "UPKG_FAMS_SETTING.USP_UPDATE_BM"
