<div class="cont_wrap">
	...
	<section class="section_pg">
		...
		<section class="section_box virt_clr">
			...
			<div class="table_wrap b1-6-1 f-l">
				<div class="gridgroup10">
		        	<div id="pFundGrid"></div>
		    	</div>
			</div>
			<div class="gf_box b1-6-2 f-r">
		...
		<section class="section_box virt_clr">
			...
			<div class="table_wrap b1-6-3 f-lc f-l">
				<div class="gridgroup10">
		        	<div id="cFundGrid"></div>
		    	</div>
			</div>
			<div class="gf_box b1-6-4 f-r">
...
<script>
$(function(){
	fng.util.loadScript('/scripts/portfolio_01-04.js');
});
</script>