...
<%
	...
	Dim cust_cd, trd_dt, grp_gb, item_nm, unit
	...
	grp_gb = request.querystring("grp_gb")
	item_nm = request.querystring("item_nm")
	...
	Comm.Parameters.Append Comm.CreateParameter("IN_GRP_CD", adVarChar, adParamInput, 10, grp_gb)
	Comm.Parameters.Append Comm.CreateParameter("IN_ITEM_NM", adVarChar, adParamInput, 30, item_nm)
	...
	Comm.CommandText = "UPKG_FAMS_PORTFOLIO.USP_ITEM_SEARCH"
	...
	If Err.Number <> 0 Then
		...
		response.write "item_nm:" & item_nm & "<br>"
