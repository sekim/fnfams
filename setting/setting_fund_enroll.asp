<div class="cont_wrap">
	<div class="guide_area virt_clr">
		<p class="gd f-r"><span>설정관리</span><span> > </span><span>등록관리</span><span> > </span><strong>펀드 등록</strong></p>
		<a href="" class="btn_print">인쇄</a>
	</div>
	<section class="section_pg">
		<h1 class="pg_title">펀드 등록</h1>
			...
			<div class="p_b6">
				<div class="option_b_box virt_clr">
					...
					<div class="fbox fbox_ty1">
						...
						<div class="cad_ty1">
							<input id="fst_trd_dt" type="text" maxlength="10" class="int_ty1 fncalendar" />
					...
					<div class="fbox fbox_ty1">
						...
						<div class="cad_ty1">
							<input id="set_dt" type="text" maxlength="10" class="int_ty1 fncalendar" />
							...
							<td class="anc">
								<div class="cad_ty2">
									<div class="input_wrap">
										<input id="fr_dt" type="text" maxlength="10" class="int_ty3 fncalendar" />
