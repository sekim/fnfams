...
<%
	...
	Dim cust_cd, bm_cd, std_dt, fr_dt, mkt_idx_cd, work_id, bm_nm, use_yn
	...
	Comm.Parameters.Append Comm.CreateParameter("IN_BM_NM", adVarChar, adParamInput, 20, bm_nm)
	...
	Comm.Parameters.Append Comm.CreateParameter("IN_MKT_IDX_CD", adVarChar, adParamInput, 20, mkt_idx_cd)
	...
	Comm.CommandText = "UPKG_FAMS_SETTING.USP_UPDATE_HIST_BM"
