$(function(){
	...
	function readCfund(param){
        ...
        function readSuccess(d){      	
            ...
            grdOpt = {
                ...
                body:[
                    ...
                    {field:'FUND_NM', align:'left'},
                    {field:'PEER_CD', align:'left'},
                    {field:'SET_DT',type:'date'},
                    {field:'FST_TRD_DT',type:'date', align:'left'},
                    {field:'CO_NM', align:'left'}
                ],
                data:d,
                page:{
                    ...
                    $('#CfundGrid').off('click', 'table>tbody>tr').on('click', 'table>tbody>tr', function(){
                        if($('td', this).eq(1).text()) {	//빈줄을 클릭한것이 아니라면.
                            ...
                            var ajaxSettingsHist = {
					            url: fng.fams.path + '/setting_fund_enroll_hist_read.asp?cust_cd=' + param.cust_cd + '&fund_cd=' + cFundData[i].FUND_CD,
					            success: readSuccess,
					            error: readError,
					            done: readDone
					        }
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_fund_s_enroll_read.asp',
            param:param,
            success: readSuccess,
            error: readError,
            done: readDone
	...
	function create(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_fund_s_enroll_create.asp',
            param:param,
	...
	function remove(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_fund_s_enroll_delete.asp',
            param:param,
