$(function(){
            ...
            callback: function(){
                $('select', '#selectCustCd').change(function(){
                    ...
                    selectPeerCdOpt = {
                        ...
                        url : fng.fams.path + '/setting_02-01_peer_read.asp?cust_cd=' + cust_cd,
                        data : {
                            PEER_NM : 'PEER_CD'
                        },
                        callback: function(){
    ...
    function read(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-01_read.asp',
            param: param,
            success: readSuccess,
            error: readError,
            done: readDone
    ...
    function create(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-01_create.asp',
            param:param,
    ...
    function update(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-01_update.asp',
            param:param,
    ...
    function remove(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-01_delete.asp',
            param:param,
