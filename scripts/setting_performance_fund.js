$(function(){
        ...
        callback: function(){
            $('select', '#selectCustCd').change(function(){
                ...
                selectPeerCdOpt = {
                    ...
                    url : fng.fams.path + '/setting_performance_fund_peer_read.asp?cust_cd=' + cust_cd,
                    data : {
                        PEER_NM : 'PEER_CD'
                    },
                    callback: function(){
    ...
    function readFundInPeer(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_performance_fund_fund_in_peer_read.asp?cust_cd=' + $selectCustCd.val() + '&peer_cd=' + $selectPeerCd.val(),
            success: readSuccess,
            error: readError,
            done: readDone
        }
    ...
    function readFundOutPeer(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_performance_fund_fund_out_peer_read.asp?cust_cd=' + $selectCustCd.val() + '&peer_cd=' + $selectPeerCd.val(),
            success: readSuccess,
            error: readError,
            done: readDone
        }
    ...
    function create(param){
           ...
           ajaxSettings = {
               url: fng.fams.path + '/setting_performance_fund_fund_in_peer_create.asp',
               param:param,
    ...
    function remove(param){
       ...
       ajaxSettings = {
           url: fng.fams.path + '/setting_performance_fund_fund_in_peer_delete.asp',
           param:param,
