...
fng.debug.log($('#fr_dt').val());
                    ...
                    $('#PfundGrid').off('click', 'table>tbody>tr').on('click', 'table>tbody>tr', function(){
                        if($('td', this).eq(1).text()) {	//빈줄을 클릭한것이 아니라면.
                            ...
                            var ajaxSettingsHist = {
					            url: fng.fams.path + '/setting_01-02_hist_read.asp?cust_cd=' + cust_cd + '&fund_cd=' + custData[i].FUND_CD,
					            success: readSuccess,
					            error: readError,
					            done: readDone
					        }
	...
	function create(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_01-02_create.asp',
            param:param,
	...
	function remove(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_01-02_delete.asp',
            param:param,
