$(function(){
	...
	function read(cust_cd){
                    ...
                    $('#BMGrid').off('click', 'table>tbody>tr').on('click', 'table>tbody>tr', function(){
                        if($('td', this).eq(1).text()) {	//빈줄을 클릭한것이 아니라면.
                            ...
                            var ajaxSettingsHist = {
					            url: fng.fams.path + '/setting_02-03_hist_read.asp?cust_cd=' + cust_cd + '&bm_cd=' + custData[i].BM_CD,
					            success: readSuccess,
					            error: readError,
					            done: readDone
					        }
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-03_read.asp?cust_cd=' + cust_cd,
            success: readSuccess,
            error: readError,
            done: readDone
        }
	...
	function create(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-03_create.asp',
            param:param,
	...
	function updateWithHist(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-03_updateWithHist.asp',
            param:param,
	...
	function update(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-03_update.asp',
            param:param,
            success: updateSuccess,
            error: updateError,
            done: updateDone
	...
	function remove(param){
        ...
        ajaxSettings = {
            url: fng.fams.path + '/setting_02-03_delete.asp',
            param:param,
