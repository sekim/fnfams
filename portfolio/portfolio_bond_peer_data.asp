...
<%
	...
	Dim cust_cd, fund_cd, trd_dt, item_cd, unit
	...
	item_cd = request.querystring("item_cd")
	...
	Comm.Parameters.Append Comm.CreateParameter("IN_ITEM_CD", adVarChar, adParamInput, 10, item_cd)
	...
	Comm.CommandText = "UPKG_FAMS_PORTFOLIO.USP_BOND_PEER"
	...
	If Err.Number <> 0 Then
		...
		response.write "item_cd:" & item_cd & "<br>"
